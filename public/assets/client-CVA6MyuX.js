...
`;
  ...
  function App({ url, initialProps }) {
    ...
    const post = asObject$1(initialProps.post);
    const postTitle = asString$1(post.title, postId ? `Post ${postId}` : "");
    const postSummary = asString$1(post.summary, "");
    const postBody = asString$1(post.body, "");
    const postAuthor = asString$1(post.author, "");
    const postPublishedAt = asString$1(post.publishedAt, "");
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { "data-theme": activeTheme, className: "h1pkg8nd h1cn6c31", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "h1nbwcgk h12rcolt h14aqli2 h10z0o3a", children: [
      ...
      isPostDetailPage ? /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { className: "h1842365 rounded-xl border border-white/20 bg-black/10 p-4", children: [
        postTitle ? /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl hzd3ouy", children: postTitle }) : null,
        postSummary ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "h16g4h0b hiyw1ix h1d14slv", children: postSummary }) : null,
        postBody ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "h1664vbc hiyw1ix leading-6", children: postBody }) : null,
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h1664vbc h1kagvzm h1t5e6r1 gap-3 hji0ntc h1d14slv", children: [
          postAuthor ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            "Author: ",
            postAuthor
          ] }) : null,
          postPublishedAt ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            "Published: ",
            postPublishedAt
          ] }) : null,
          postReadMinutes !== null ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            "Read: ",
            postReadMinutes,
            " min"
          ] }) : null,
          postLikes !== null ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            "Likes: ",
            postLikes
          ] }) : null
        ] }),
  ...
  function resolveHydraRoute(fallbackUrl, props, requestContext = {}) {
    ...
    const fallbackRouteUrl = asString(requestContext.routeUrl, fallbackUrl || fallbackPath) || fallbackPath;
  ...
  if (root) {
    ...
    const requestContext = typeof rawProps.__hydra_request === "object" && rawProps.__hydra_request !== null ? rawProps.__hydra_request : {};
    ...
    hydrateRoot(
      root,
      /* @__PURE__ */ jsxRuntimeExports.jsx(App, { url: route.routeUrl, initialProps: pageProps })
    );
  }
})();
//# sourceMappingURL=client-CVA6MyuX.js.map
