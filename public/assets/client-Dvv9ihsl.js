...
`;
  const koCatalogPo = '# HydraStack UI translations (Korean)\nmsgid ""\nmsgstr ""\n"Language: ko\\n"\n"Content-Type: text/plain; charset=UTF-8\\n"\n\nmsgid "hello_from_hydrastack"\nmsgstr "Annyeong from HydraStack"\n\nmsgid "route"\nmsgstr "Route"\n\nmsgid "full_url"\nmsgstr "Full URL"\n\nmsgid "locale"\nmsgstr "Locale"\n\nmsgid "locale_candidates"\nmsgstr "Locale candidates"\n\nmsgid "ssr_burn"\nmsgstr "SSR burn"\n\nmsgid "isolate_counter"\nmsgstr "Isolate counter"\n\nmsgid "bridge_status"\nmsgstr "Bridge status"\n\nmsgid "hydrated_clicks"\nmsgstr "Hydrated clicks"\n';
  ...
  const CATALOGS = {
    en: parsePo(enCatalogPo),
    fr: parsePo(frCatalogPo),
    ko: parsePo(koCatalogPo)
  };
  ...
  function App({ url, initialProps }) {
    ...
    const message = asString(initialProps.message, _("hello_from_hydrastack"));
...
//# sourceMappingURL=client-Dvv9ihsl.js.map
