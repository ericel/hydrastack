(function() {
  ...
  const LOCALE_COPY = {
    en: {
      heading: "Hello from HydraStack app",
      routeLabel: "Route",
      fullUrlLabel: "Full URL",
      localeLabel: "Locale",
      localeCandidatesLabel: "Locale candidates",
      ssrBurnLabel: "SSR burn",
      isolateCounterLabel: "Isolate counter",
      bridgeStatusLabel: "Bridge status",
      hydratedClicksLabel: "Hydrated clicks"
    },
    fr: {
      heading: "Bonjour depuis HydraStack",
      routeLabel: "Route",
      fullUrlLabel: "URL complete",
      localeLabel: "Langue",
      localeCandidatesLabel: "Candidats de langue",
      ssrBurnLabel: "Charge SSR",
      isolateCounterLabel: "Compteur d'isolate",
      bridgeStatusLabel: "Etat bridge",
      hydratedClicksLabel: "Clics hydrates"
    },
    ko: {
      heading: "Annyeong from HydraStack",
      routeLabel: "Route",
      fullUrlLabel: "Full URL",
      localeLabel: "Locale",
      localeCandidatesLabel: "Locale candidates",
  ...
  function resolveCopy(localeValue) {
    const normalized = localeValue.trim().toLowerCase();
    if (normalized && LOCALE_COPY[normalized]) {
      return LOCALE_COPY[normalized];
    }
    const separator = normalized.indexOf("-");
    if (separator > 0) {
      const base = normalized.slice(0, separator);
      if (LOCALE_COPY[base]) {
        return LOCALE_COPY[base];
      }
    }
    return LOCALE_COPY.en;
  }
  function App({ url, initialProps }) {
    ...
    const locale = asString(requestContext.locale, "en").toLowerCase();
    const localeCandidates = asStringArray(requestContext.localeCandidates);
    const copy = resolveCopy(locale);
    const message = asString(initialProps.message, copy.heading);
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "min-h-screen bg-gradient-to-b from-deep-900 to-deep-700 text-slate-100", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-3xl px-6 py-16", children: [
      ...
      localeCandidates.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-1 text-xs text-slate-400", children: [
        copy.localeCandidatesLabel,
        ": ",
...
//# sourceMappingURL=client-l2em8wFc.js.map
