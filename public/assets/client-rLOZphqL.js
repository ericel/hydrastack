...
`;
  ...
  function App({ url, initialProps }) {
    ...
    const message = asString$1(initialProps.message, _("hello_from_hydrastack"));
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "min-h-screen bg-gradient-to-b from-deep-900 to-deep-700 text-slate-100", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-3xl px-6 py-16", children: [
      ...
      postId ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-1 text-xs text-slate-400", children: [
        "Post ID: ",
        postId
      ] }) : null,
      querySummary ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-1 text-xs text-slate-400", children: [
        "Query params: ",
        querySummary
      ] }) : null,
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-2 text-xs text-slate-400", children: [
    ...
    switch (route.pageId) {
      case "post_detail": {
        ...
        pageProps = {
          ...
          page: "post_detail",
          postId,
          message: ensureString(pageProps.message, postId ? `Post ${postId}` : "Post detail")
        };
        break;
      }
      case "home":
      default:
        pageProps = {
          ...pageProps,
          page: "home",
          message: ensureString(pageProps.message, "Hello from HydraStack app")
        };
        break;
    }
    hydrateRoot(
...
//# sourceMappingURL=client-rLOZphqL.js.map
